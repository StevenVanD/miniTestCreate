...
public class SwipeTest : MonoBehaviour
{
    ...
    static SwipeTest instance;
    public static Vector2 maxSwipevelocity;
    ...
    void Update()
    {
        autoDetectSwipes = swipeDetected;
        if (autoDetectSwipes)
        {
            DetectSwipe();
        }
    ...
    static void DetectSwipe()
    {
        if (GetTouchInput() || GetMouseInput())
        {
            ...
            //advanced
            /*if (maxSwipevelocity.x < swipeVelocity.x && swipeVelocity.x > 0)
            {
                maxSwipevelocity = swipeVelocity;
            }
            if (maxSwipevelocity.x > swipeVelocity.x && swipeVelocity.x < 0)
            {
                maxSwipevelocity = swipeVelocity;
